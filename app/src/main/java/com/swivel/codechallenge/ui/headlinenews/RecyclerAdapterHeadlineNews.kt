...
class RecyclerAdapterHeadlineNews (private val context: Context, private var headlineNewsViewModel: HeadlineNewsViewModel) : RecyclerView.Adapter<RecyclerAdapterHeadlineNews.MyViewHolder>() {
    ...
    override fun getItemCount(): Int {
        return headlineNewsViewModel.getHeadlineNewsSize()
    }

    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {

        headlineNewsViewModel.getHeadlineNewsAt(position)?.let {
            holder.apply {
                val article = it
